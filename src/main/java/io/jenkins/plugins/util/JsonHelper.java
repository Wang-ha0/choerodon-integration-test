...
public final class JsonHelper {
    ...
    public static <T> T unmarshalByJackson(String json, Class<T> type) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to unmarshal by jackson. It's unexpected and may be an internal devops. The json is: " + json, e);
        }
    }
    ...
    public static String marshalByJackson(Object object) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to marshal by jackson. It's unexpected and may be an internal devops. The object is: " + object.toString(), e);
        }
    }
